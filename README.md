...
| helmfile     | <!-- # renovate: datasource=github-releases depName=helmfile/helmfile --> 1.1.9   | A declarative spec for deploying Helm charts.                   |
| jq           | <!-- # renovate: datasource=github-releases depName=jqlang/jq --> 1.7.1   | A lightweight and flexible command-line JSON processor.         |
| kubectl      | <!-- # renovate: datasource=github-tags depName=kubernetes/kubectl --> 1.34.1  | The Kubernetes command-line tool.                               |
...
| vals         | <!-- # renovate: datasource=github-releases depName=helmfile/vals --> 0.42.4  | A tool for fetching and templating values from various sources (Vault, SSM, etc.). |
| yq           | <!-- # renovate: datasource=github-releases depName=mikefarah/yq --> 4.48.1  | A command-line YAML, JSON, and XML processor.                   |
...
|-------------|----------|----------------------------------------------------------------|
| helm-diff   | <!-- # renovate: datasource=github-releases depName=databus23/helm-diff --> 3.13.1  | A helm plugin for previewing helm upgrade as a diff.           |
| helm-git    | <!-- # renovate: datasource=github-releases depName=aslafy-z/helm-git --> 1.4.1   | A helm plugin for installing charts from Git repositories.     |
| helm-secrets| <!-- # renovate: datasource=github-releases depName=jkroepke/helm-secrets --> 4.6.11   | A helm plugin for managing secrets with sops or other secret backends. |
...
repoServer:
  initContainers:
    - name: gitops-tools
      image: ajaykumar4/gitops-tools:2025.10.0
