...
| helmfile     | <!-- # renovate: datasource=github-releases depName=helmfile/helmfile --> 1.5.5   | A declarative spec for deploying Helm charts.                   |
| jq           | <!-- # renovate: datasource=github-releases depName=jqlang/jq --> 1.7.1   | A lightweight and flexible command-line JSON processor.         |
| kubectl      | <!-- # renovate: datasource=github-tags depName=kubernetes/kubectl --> 1.36.4  | The Kubernetes command-line tool.                               |
...
| vals         | <!-- # renovate: datasource=github-releases depName=helmfile/vals --> 0.44.5  | A tool for fetching and templating values from various sources (Vault, SSM, etc.). |
...
repoServer:
  initContainers:
    - name: gitops-tools
      image: ajaykumar4/gitops-tools:2026.9.0
