...
|--------------|----------|-----------------------------------------------------------------|
| age          | <!-- # renovate: datasource=github-releases depName=FiloSottile/age --> 1.3.0   | A simple, modern, and secure file encryption tool.              |
...
| vals         | <!-- # renovate: datasource=github-releases depName=helmfile/vals --> 0.42.6  | A tool for fetching and templating values from various sources (Vault, SSM, etc.). |
...
| helm-git    | <!-- # renovate: datasource=github-releases depName=aslafy-z/helm-git --> 1.5.1   | A helm plugin for installing charts from Git repositories.     |
