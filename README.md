...
| helmfile     | <!-- # renovate: datasource=github-releases depName=helmfile/helmfile --> 1.4.2   | A declarative spec for deploying Helm charts.                   |
...
|-------------|----------|----------------------------------------------------------------|
| helm-diff   | <!-- # renovate: datasource=github-releases depName=databus23/helm-diff --> 3.15.2  | A helm plugin for previewing helm upgrade as a diff.           |
