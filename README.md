...
| helmfile     | <!-- # renovate: datasource=github-releases depName=helmfile/helmfile --> 1.1.7   | A declarative spec for deploying Helm charts.                   |
...
| yq           | <!-- # renovate: datasource=github-releases depName=mikefarah/yq --> 4.47.2  | A command-line YAML, JSON, and XML processor.                   |
...
| helm-secrets| <!-- # renovate: datasource=github-releases depName=jkroepke/helm-secrets --> 4.6.10   | A helm plugin for managing secrets with sops or other secret backends. |
