...
| helm-secrets| <!-- # renovate: datasource=github-releases depName=jkroepke/helm-secrets --> 4.7.0   | A helm plugin for managing secrets with sops or other secret backends. |
