...
|-------------|----------|----------------------------------------------------------------|
| helm-diff   | <!-- # renovate: datasource=github-releases depName=databus23/helm-diff --> 3.15.3  | A helm plugin for previewing helm upgrade as a diff.           |
...
repoServer:
  initContainers:
    - name: gitops-tools
      image: ajaykumar4/gitops-tools:2026.3.0
