...
| vals         | <!-- # renovate: datasource=github-releases depName=helmfile/vals --> 0.42.2  | A tool for fetching and templating values from various sources (Vault, SSM, etc.). |
...
|-------------|----------|----------------------------------------------------------------|
| helm-diff   | <!-- # renovate: datasource=github-releases depName=databus23/helm-diff --> 3.13.0  | A helm plugin for previewing helm upgrade as a diff.           |
